...
public class Int101Homework02Updated {
    ...
    static void work01Utilitor() {
       ...
       1.5 Show in this "work01Utilitor" method how to
        ...
        System.out.println(Utilitor.testString("Hello World Test"));
        System.out.println(Utilitor.testPositive(49));
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to
        ...
        Person f = new Person("Pongboripat", "Jangnok");
        System.out.println(f);
        Person g = new Person("Tomas", "Shelby");
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to
        ...
        Person p = new Person("Pongboripat", "Jangnok");
        Account bankP = new Account(p);
        Person x = new Person("Tomas", "Shelby");
        Account bankX = new Account(x);
        bankP.deposit(5000);
        bankX.deposit(500);
        bankX.withdraw(1500);
        bankP.transfer(200, bankX);
        System.out.println(bankP);
        System.out.println(bankX);
    }
}
